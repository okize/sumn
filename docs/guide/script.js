...
var hints = {
  "home": "This is a cheatsheet for the SUMN <strong>user.json</strong> configuration file. <br/><br/> You can access information about properties by <strong>mousing over</strong> or <strong>clicking</strong> the property name.</li></ul>",
  "username": "The unique name of your package. <br/><br/> This will also indicate the name of the package in the <a href='http://search.npmjs.org'>NPM global repository</a> ( if you choose to publish it. ) <br/><br/> On <a href='http://nodejitsu.com'>Nodejitsu</a>, this property will represent the name of your application.",

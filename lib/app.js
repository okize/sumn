...
var sites = require(process.cwd() + '/lib/modules/sites'),
    ...
    cfg = require(process.cwd() + '/lib/config.json'); // configuration files
...
exports.createSite = function (sitename, dirname) {
  ...
  if (typeof sitename === 'undefined') {
    ...
    if (!files.doesDirectoryExist(dirname)) {
...
exports.releaseSite = function (sitename, env) {
  ...
  if (!files.doesBuildDirectoryExist(dirname)) {
  ...
  files.pushToMedia(filePaths, env);

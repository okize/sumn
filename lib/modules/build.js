...
var devPath = './sites/dev/', // location of dev dirs
    buildPath = './sites/build/'; // location of build dirs
...
exports.getAssetPaths = function (sitename, destination, assetTypes, environment) {
  ...
  var localDir = path.join(__dirname, '../../', buildPath, siteDir, '/');
  console.log(localDir);

  // set the correct file path
  var destinationMap = {
    local: localDir, // @todo (see localAssetDirs)
...
exports.doesBuildDirectoryExist = function (dirname) {
  ...
  var buildDir = buildPath + dirname;
...
exports.compileAssets = function (sitename) {
  ...
  var config = {
    name: devPath + '_global/javascript/almond',
    include: devPath + sitename + '/javascript/main',
    out: buildPath + sitename + '/javascript/script.js',
    wrap: true,
    optimize: 'none'
  };

...
var fs = require('fs');
var cfg = JSON.parse(fs.read('./lib/config.json'));

// location of local copy of jQuery
var jqLocal = './src/_global/libraries/jquery-1.8.2.js';
...
var cdnPassword = cfg.cdn.password;
...
// time to go
casper.run(function() {
    this.echo(' All done jabrone! ', 'INFO_BAR').exit();
});